...
### NOW WE START PRODUCING THE SET OF IMAGES
...
plot(x = my_data$TIME, y = my_data$Voltage, xlab = "datetime", 
     ylab = "Voltage", type = "l")

### Bottom right plot

plot(x = my_data$TIME, y = my_data$Global_reactive_power, xlab = "datetime", 
